...
export class NotificationsService {
  ...
  async notifyMoneyReceived(userId: string, amountUsdc: string, senderName: string) {
    return this.create({
      userId,
  ...
  async notifyTransactionComplete(userId: string, reference: string, amountUsdc: string) {
    return this.create({
      userId,
      type:     NotificationType.MONEY,
