...
// 24px viewBox · 1.5px stroke · strokeLinecap="round" · strokeLinejoin="round" · no fill · no gradients
...
function Icon({ size = 24, color = "currentColor", className = "", children }: IconProps & { children: React.ReactNode }) {
  return (
    <svg
      {...base}
      width={size}
...
/** Cheese wedge — brand icon */
export function IconCheese(props: IconProps) {
  return (
    <Icon {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M2 20h20L12 3 2 20z" />
...
export function IconRocket(props: IconProps) {
  return (
    <Icon {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 0 1-5.84 7.38v-4.82m5.84-2.56a14.95 14.95 0 0 0 6.16-12.12A14.95 14.95 0 0 0 9.47 2.3a14.95 14.95 0 0 0-2.17 6.97m8.29 5.1a14.92 14.92 0 0 1-3.27.57M6.29 8.63a6 6 0 0 0-2.19 4.97 6 6 0 0 0 3.39 2.77M6.29 8.63 3 9.75l3.29-1.12zm9.3 5.74 3.29 1.13-3.29-1.13z" />
    </Icon>
  );
}

/** Banknote / fund bonus */
export function IconBanknotes(props: IconProps) {
  return (
    <Icon {...props}>
...
export function IconTrophy(props: IconProps) {
  return (
    <Icon {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9m9 0a3 3 0 0 1 3 3h-15a3 3 0 0 1 3-3m9 0v-3.375c0-.621-.503-1.125-1.125-1.125h-.871M7.5 18.75v-3.375c0-.621.504-1.125 1.125-1.125h.872m5.007 0H9.497m5.007 0a7.454 7.454 0 0 1-.982-3.172M9.497 14.25a7.454 7.454 0 0 0 .981-3.172M5.25 4.236c-.982.143-1.954.317-2.916.52A6.003 6.003 0 0 0 7.73 9.728M5.25 4.236V4.5c0 2.108.966 3.99 2.48 5.228M5.25 4.236V2.721C7.456 2.147 9.662 1.862 12 1.862c2.338 0 4.545.285 6.75.858v1.515M18.75 4.236c.982.143 1.954.317 2.916.52a6.003 6.003 0 0 1-5.395 5.492M18.75 4.236V4.5a6.74 6.74 0 0 1-2.48 5.228" />
    </Icon>
  );
}
...
/** Building office / CBN compliance */
export function IconBuildingOffice(props: IconProps) {
  return (
    <Icon {...props}>
